...
# \end{equation}
# 
# With the following parameters from Smith+(2009 MNRAS 397, 868) for Field Galaxies in SDSS and UKIRT at z$\sim$0.1 in the Kband:
# 
# 
...
#You will need to determine the normalization, $\xi_0$, by integrating this equation over mass from m_min= 0.1 to m_max = 120 M$_\odot and setting the result to 1.  
