...
# # Part C
# 
# a) Create a scatter plot of the edge on disk particles, color coded by velocity.
...
density_contour(cyl_r, cyl_theta, 80, 80, ax=ax, 
                colors=['red', 'white', 'white', 'magenta'])
